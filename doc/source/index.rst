.. nqch-quantum documentation master file, created by
   sphinx-quickstart on Fri Dec 15 11:46:09 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

What is nqch-quantum?
====================

NQCH-Quantum is the front end interface to NQCH Quantum Computing Cloud Platform.
...
.. code-block:: python
   ...
   >>> from nqch_quantum import Client
   >>> import qibo
